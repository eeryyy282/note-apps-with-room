package com.example.noteappswithroom.ui.insert
...
class NoteAddUpdateActivity : AppCompatActivity() {
    ...
    private var _activityNoteAddUpdateBiding: ActivityNoteAddUpdateBinding? = null
    private val binding get() = _activityNoteAddUpdateBiding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()

        _activityNoteAddUpdateBiding = ActivityNoteAddUpdateBinding.inflate(layoutInflater)
    ...
    private fun showAlertDialog(type: Int) {
        ...
        val dialogMessege: String
        if (isDialogClose) {
            dialogTitle = getString(R.string.cancel)
            dialogMessege = getString(R.string.message_cancel)
        } else {
            dialogMessege = getString(R.string.message_delete)
    ...
    override fun onDestroy() {
        super.onDestroy()
        _activityNoteAddUpdateBiding = null
    }
